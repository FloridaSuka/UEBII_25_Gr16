...
<div class="form-section">
    ...
    <form method="POST">
        ...
        <?php
        $aftesite = [
            1 => "Njohuri të thelluara teknike dhe zgjidhje të problemeve",
            2 => "Aftësi për të përdorur softuerë inxhinierikë (CAD, MATLAB, etj.)",
            3 => "Përvojë në hartimin dhe zbatimin e projekteve teknike",
            4 => "Aftësi për të punuar në ekipe ndërdisiplinore",
            5 => "Përgatitja e raporteve teknike dhe dokumentacionit të projekteve"
        ];
