...
<head>
    ...
    <title>Detajet e Profesionit - Avokat</title>
    <style>
         ::-webkit-scrollbar{
        width: 10px;
        }
        ...
        .profession-details {
            position: relative;
            background-image: url('foto/avokat.webp'); /* Ndryshoni për foton e kuzhinës */
...
<div class="profession-title">
      <b>Detajet e Profesionit - Avokat</b>
    </div>
    ...
    <div class="profilit">
        ...
        <h3>
            Përfaqësimi ligjor dhe këshillimi i klientëve në çështje juridike.
        </h3>
    </div>
    ...
    <div class="requirements">
        ...
        <ul class="ul">
            <li class="li">Diplomë në drejtësi dhe licencë për ushtrimin e profesionit të avokatit.</li>
            <li class="li">Njohuri të thelluara në legjislacionin kombëtar dhe ndërkombëtar.</li>
            <li class="li">Aftësi të shkëlqyera në analizimin dhe zgjidhjen e çështjeve juridike.</li>
            <li class="li">Aftësi për të komunikuar me klientët dhe përfaqësuesit e palëve të tjera.</li>
        </ul>
    </div>

    <h2>Përfitimet</h2>
    <p>
        Duke punuar si avokat, mund të përfitoni:
    </p>
    <ul class="ul">
        <li class="li">Mundësi për të ndihmuar klientët në arritjen e drejtësisë.</li>
...
<h2>Aplikim për pozitën Avokat</h2>
