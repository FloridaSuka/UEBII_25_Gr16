<?php
// Këtu mund të vendosësh kodin PHP nëse duhet
?>
<!DOCTYPE html>
<html lang="sq">
<head>
    ...
    <style>
        ...
        .profession-details {
            position: relative;
            background-image: url('foto/Tradita_Kacanik.jpg'); /* Ndryshoni për foton e kuzhinës */
...
<main>
    ...
    <div class="profession-title">
      <b> Detajet e Profesionit - Kuzhinier</b>  
    </div>
    ...
    <div class="profilit">
        <h1>
            Profili i Kuzhinierit
        </h1>
        <h3>
            Përgatitja e ushqimeve të shijshme dhe të shëndetshme për konsumatorët, duke siguruar cilësi dhe prezantim të shkëlqyer.
        </h3>
    </div>
    ...
    <div class="requirements">
        ...
        <ul class="ul">
            <li>Eksperiencë në gatim dhe ndjekje të recetave.</li>
            <li>Aftësi për të punuar në grup dhe nën presion.</li>
            <li>Njohuri mbi sigurinë ushqimore dhe higjienën e kuzhinës.</li>
            <li>Aftësi për të menaxhuar kohën dhe përgatitur më shumë se një pjatë njëkohësisht.</li>
        </ul>
    </div>
    ...
    <h2>Përfitimet</h2>
    <p>
        Duke punuar si kuzhinier, mund të përfitoni:
    </p>
    <ul class="ul">
        <li>Paga konkurruese dhe mundësi rritjeje.</li>
        <li>Fleksibilitet në oraret e punës dhe mundësi për të krijuar receta të reja.</li>
        <li>Pjesëmarrje në evente dhe mundësi për të zhvilluar aftësitë profesionale.</li>
    </ul>
...
<div class="form-section">
    ...
    <form id="application-form" action="" method="POST" enctype="multipart/form-data">
        ...
        <form oninput="calculateMatch()">
            ...
            <label><input type="checkbox" name="skill" value="1"> Eksperiencë e Mjaftueshme në Kuzhinë</label><br>
            <label><input type="checkbox" name="skill" value="2"> Njohuri të Standardeve të Higjenës dhe Sigurisë Ushqimore</label><br>
            <label><input type="checkbox" name="skill" value="3"> Aftësi për Të Menaxhuar Ekipin e Kuzhinës dhe Koordinuar Punën</label><br>
            <label><input type="checkbox" name="skill" value="4"> Aftësi për Të Krijuar dhe Ndjekur Menu dhe Receta</label><br>
            <label><input type="checkbox" name="skill" value="5"> Aftësi për Punë nën Presion dhe në Orar të Ngarkuar</label><br><br>
