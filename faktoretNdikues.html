...
<head>
    ...
    <title>Faktor&#235t ndikues n&#235 p&#235rzgjedhjen e karrier&#235s</title>
    <style>
    ::-webkit-scrollbar{
     width: 10px;
    }
    ...
    ::-webkit-scrollbar-thumb{
        ...
        .faktoret-p {
            ...
            color: white;
            margin-bottom: 20px;
            font-style: italic; /* Shtoni stilin italik për të gjitha paragrafët */
        }
        .faktoret-section {
            margin-bottom: 40px;
            padding: 20px;
...
<script>
    const sections = document.querySelectorAll('.faktoret-section');
    let currentIndex = 1;
