...
<head>
    ...
    <title>Detajet e Profesionit - Fotograf</title>
    <style>
         ::-webkit-scrollbar{
        width: 10px;
        }
        ...
        .profession-details {
            position: relative;
            background-image: url('foto/fotograf.webp'); 
...
<main>
  ...
  <b>     Detajet e Profesionit - Fotograf</b>
   ...
   <!-- Seksioni i Profilit -->
   <div class="profilit">
       <h1>Profili i Fotografit</h1>
       <h3>  Kapja e momenteve unike dhe krijimi i imazheve artistike për klientë dhe projekte të ndryshme.</h3>
   </div>
   ...
   <div class="requirements">
       ...
       <ul class="ul">
        <li>Njohuri mbi përdorimin e kamerave profesionale dhe lenteve të ndryshme.</li>
        <li>Aftësi për të përpunuar fotografi duke përdorur software si Adobe Photoshop dhe Lightroom.</li>
        <li>Kreativitet dhe sy për detaje në kompozimin e fotografive.</li>
        <li>Aftësi për të punuar me klientë dhe për të menaxhuar projekte të shumta njëkohësisht.</li>
       </ul>
   </div>

   <!-- Seksioni i Përfitimeve -->
   <h2>Përfitimet</h2>
   <p> Duke punuar si fotograf, mund të përfitoni:</p>
   <ul class="ul">
    <li>Mundësi për të shprehur kreativitetin tuaj në projekte të ndryshme.</li>
