...
<head>
    ...
    <title>Detajet e Profesionit - Mesues</title>
    <style>
         ::-webkit-scrollbar{
        width: 10px;
        }
        ...
        .profession-details {
            position: relative;
            background-image: url('foto/Shkolla e Mesme Alpbach.jpg'); /* Ndryshoni për foton e kuzhinës */
...
<h2>Aplikim për pozitën Mesues</h2>
