...
<div class="form-section">
    ...
    <form method="POST">
        ...
        <?php
      $aftesite = [
        1 => "Njohuri të avancuara në rrjete kompjuterike dhe siguri",
        2 => "Përvojë me sisteme operative (Windows, Linux)",
        3 => "Aftësi në mirëmbajtjen dhe konfigurimin e pajisjeve teknologjike",
        4 => "Eksperiencë me softuer dhe hardware troubleshooting",
        5 => "Aftësi për të ofruar mbështetje teknike dhe trajnime për përdoruesit"
    ];
