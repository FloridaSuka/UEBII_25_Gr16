...
<head>
    ...
    <title>Detajet e Profesionit - IT Specialist</title>
    <style>
         ::-webkit-scrollbar{
        width: 10px;
        }
        ...
        .profession-details {
            position: relative;
            background-image: url('foto/IT Solution Gjilan.jpg'); /* Ndryshoni për foton e IT Specialist */
...
<main>
    ...
    <div class="profession-title">
     <b>  Detajet e Profesionit - IT Specialist</b>
    </div>
    ...
    <div class="profilit">
        <h1>
            Profili i IT Specialist
        </h1>
        <h3>
            Menaxhimi, optimizimi dhe mbështetje për sisteme dhe rrjete informatike, duke siguruar funksionimin e pa ndërprerë të teknologjisë.
        </h3>
    </div>
    ...
    <div class="requirements">
        ...
        <ul class="ul">
            <li class="li">Diplomë në Shkenca Kompjuterike, Teknologji Informacioni ose fushë të ngjashme.</li>
            <li class="li">Njohuri të thella të sistemeve operativë, programeve dhe rrjeteve informatike.</li>
            <li class="li">Eksperiencë në konfigurimin dhe mirëmbajtjen e sistemeve dhe rrjeteve informatike.</li>
            <li>Aftësi të shkëlqyera për zgjidhjen e problemeve dhe komunikim efektiv.</li>
        </ul>
    </div>
    ...
    <h2>Përfitimet</h2>
    <p>
        Duke punuar si IT Specialist, mund të përfitoni:
    </p>
    <ul class="ul">
        <li class="li">Paga konkurruese dhe mundësi për zhvillim profesional të vazhdueshëm.</li>
        <li class="li">Mundësi për të punuar me teknologjitë më të fundit dhe inovative.</li>
        <li class="li">Fleksibilitet në orarin e punës dhe mundësia e punës nga distanca.</li>
    </ul>
...
<div class="form-section">
    ...
    <br>
        ...
        <form oninput="calculateMatch()">
            ...
            <label><input type="checkbox" name="skill" value="1"> Eksperiencë në Mbështetje Teknike dhe Zgjidhje të Problemeve</label><br>
            <label><input type="checkbox" name="skill" value="2"> Njohuri të Avancuara të Sistemeve Operative dhe Rrjetave</label><br>
            <label><input type="checkbox" name="skill" value="3"> Aftësi për Menaxhimin e Sigurisë të IT-së dhe Mbrojtjes së të Dhënave</label><br>
            <label><input type="checkbox" name="skill" value="4"> Aftësi për Zhvillimin dhe Implementimin e Software-ve dhe Aplikacioneve</label><br>
            <label><input type="checkbox" name="skill" value="5"> Aftësi për Menaxhimin e Projekteve IT dhe Koordinimin e Ekipit</label><br><br>
