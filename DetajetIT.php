...
<head>
    ...
    <title>Detajet e Profesionit -IT</title>
    <style>
         ::-webkit-scrollbar{
        width: 10px;
        }
        ...
        .profession-details {
            position: relative;
            background-image: url('foto/IT Solution Gjilan.jpg'); /* Ndryshoni për foton e kuzhinës */
