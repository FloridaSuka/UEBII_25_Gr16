...
<head>
    ...
    <title>Detajet e Profesionit - Kontabilist</title>
    <style>
        ::-webkit-scrollbar{
        width: 10px;
        }
        ...
        .profession-details {
            position: relative;
            background-image: url('foto/kontabilist.webp'); 
...
<main>
    <div class="profession-title">
     <b> Detajet e Profesionit - Kontabilist</b>  
    </div>
    ...
    <div class="profilit">
        <h1>
            Profili i Kontabilistit
        </h1>
        <h3>
            Menaxhimi i financave dhe ofrimi i këshillave për bizneset dhe individët.
        </h3>
    </div>
    ...
    <div class="requirements">
        ...
        <ul class="ul">
            <li>Njohuri mbi ligjet dhe rregulloret fiskale.</li>
            <li>Aftësi në përdorimin e software-ve si Excel, QuickBooks dhe të ngjashme.</li>
            <li>Shkathtësi në analizimin e raporteve financiare dhe planifikimin buxhetor.</li>
            <li>Aftësi për të komunikuar dhe bashkëpunuar me klientë.</li>
        </ul>
    </div>

    <h2>Përfitimet</h2>
    <p>
        Duke punuar si kontabilist, mund të përfitoni:
    </p>
    <ul class="ul">
        <li>Mundësi për të zhvilluar aftësitë në menaxhimin financiar.</li>
        <li>Siguri dhe stabilitet në punë me rroga konkurruese.</li>
        <li>Mundësi për ngritje profesionale në fusha të ndryshme.</li>
    </ul>
...
<div class="form-section">
    ...
    <br>
        ...
        <form oninput="calculateMatch()">
            ...
            <label><input type="checkbox" name="skill" value="1"> Eksperiencë e Mjaftueshme në Kontabilitet</label><br>
            <label><input type="checkbox" name="skill" value="2"> Njohuri të Forta të Ligjeve dhe Regulloreve Fiskale</label><br>
            <label><input type="checkbox" name="skill" value="3"> Aftësi për të Përdorur Softuerët e Kontabilitetit</label><br>
            <label><input type="checkbox" name="skill" value="4"> Aftësi për Të Hartuar Raporte Financiare dhe Bilance</label><br>
            <label><input type="checkbox" name="skill" value="5"> Aftësi për Të Punuar në Shtesa të Shtetit dhe në Projekte të Veçanta</label><br><br>
